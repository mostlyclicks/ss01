...
ActiveRecord::Schema.define(:version => 20150611204519) do
  ...
  create_table "refinery_contributors", :force => true do |t|
    t.string   "name"
    t.text     "description"
    t.integer  "image_id"
    t.integer  "position"
  ...
  create_table "refinery_quotes", :force => true do |t|
    t.string   "name"
    t.text     "quote_text"
    t.integer  "position"
    t.datetime "created_at", :null => false
  ...
  create_table "refinery_team_members", :force => true do |t|
    t.string   "name"
    t.integer  "image_id"
    t.string   "title"
    t.text     "description"
